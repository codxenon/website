...
### Enable Plugins And Keyboard Passthrough
...
- `allow_game_relative_writes = true` allows game-relative writes used by CoD Xe
  and installed mods.
- `keyboard_mode = 2` enables keyboard passthrough. This is required for the
  in-game console to function correctly in CoD Xe.
